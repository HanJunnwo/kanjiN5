...
export const stories: Story[] = [
  {
    ...
    kanjiUsed: ["田", "中", "毎", "日", "六", "時", "朝", "食", "七", "半", "家", "出", "学", "校", "歩", "十", "五", "分", "友", "山", "二", "人", "教", "室", "入", "先", "生", "来", "前", "本", "読", "今", "語", "数", "好", "昼", "魚", "白"],
    furigana: {"田":"た","中":"なか","毎":"まい","日":"にち","六":"ろく","時":"じ","朝":"あさ","食":"た","七":"しち","半":"はん","家":"いえ","出":"で","学":"がっ","校":"こう","歩":"ある","十":"じゅう","五":"ご","分":"ふん","友":"とも","山":"やま","二":"ふた","人":"り","教":"きょう","室":"しつ","入":"はい","先":"せん","生":"せい","来":"く","前":"まえ","本":"ほん","読":"よ","今":"きょ","語":"ご","数":"すう","好":"す","昼":"ひる","魚":"さかな","白":"しろ"}
  },
  {
    id: 2,
  ...
  },
  {
    ...
    kanjiUsed: ["先", "週", "土", "東", "行", "朝", "九", "時", "電", "車", "駅", "入", "新", "買", "三", "店", "白", "青", "千", "円", "五", "少", "高", "物", "友", "会", "一", "昼", "食", "近", "小", "午", "後", "本", "日", "語", "二", "来", "試", "六", "家"],
    furigana: {"先":"せん","週":"しゅう","土":"ど","東":"とう","行":"い","朝":"あさ","九":"く","時":"じ","電":"でん","車":"しゃ","駅":"えき","入":"はい","新":"あたら","買":"か","三":"さん","店":"みせ","白":"しろ","青":"あお","千":"ぜん","円":"えん","五":"ご","少":"すこ","高":"たか","物":"もの","友":"とも","会":"あ","一":"いっ","昼":"ひる","食":"た","近":"ちか","小":"ちい","午":"ご","後":"ご","本":"ほん","日":"にち","語":"ご","二":"に","来":"らい","試":"し","六":"ろく","家":"いえ"}
  },
  {
    id: 4,
    ...
    kanjiUsed: ["今", "日", "休", "天", "気", "空", "青", "風", "少", "午", "前", "十", "時", "朝", "食", "大", "花", "赤", "白", "中", "川", "水", "魚", "見", "子", "近", "遊", "木", "下", "座", "本", "読", "後", "三", "友", "来", "一", "茶"],
    furigana: {"今":"きょ","日":"う","休":"やす","天":"てん","気":"き","空":"そら","青":"あお","風":"かぜ","少":"すこ","午":"ご","前":"ぜん","十":"じゅう","時":"じ","朝":"あさ","食":"た","大":"おお","花":"はな","赤":"あか","白":"しろ","中":"なか","川":"かわ","水":"みず","魚":"さかな","見":"み","子":"こ","近":"ちか","遊":"あそ","木":"き","下":"した","座":"すわ","本":"ほん","読":"よ","後":"ご","三":"さん","友":"とも","来":"き","一":"いち","茶":"ちゃ"}
  },
  {
    id: 5,
    ...
    kanjiUsed: ["山", "田", "元", "気", "日", "本", "来", "三", "月", "毎", "学", "校", "語", "先", "生", "外", "国", "十", "五", "人", "中", "東", "小", "駅", "歩", "分", "近", "大", "買", "物", "友", "一", "富", "見", "行", "上", "白", "雪", "写", "真", "試", "今", "時", "間", "少", "手", "紙", "書", "体"],
    furigana: {"山":"やま","田":"だ","元":"げん","気":"き","日":"に","本":"ほん","来":"き","三":"さん","月":"げつ","毎":"まい","学":"がっ","校":"こう","語":"ご","先":"せん","生":"せい","外":"がい","国":"こく","十":"じゅう","五":"ご","人":"にん","中":"ちゅう","東":"とう","小":"ちい","駅":"えき","歩":"ある","分":"ふん","近":"ちか","大":"おお","買":"か","物":"もの","友":"とも","一":"いっ","富":"ふ","見":"み","行":"い","上":"うえ","白":"しろ","雪":"ゆき","写":"しゃ","真":"しん","試":"し","今":"いま","時":"じ","間":"かん","少":"すこ","手":"て","紙":"がみ","書":"か","体":"からだ"}
  },
  {
    id: 6,
    ...
    kanjiUsed: ["夏", "休", "家", "族", "東", "新", "二", "時", "半", "駅", "大", "山", "見", "一", "日", "有", "名", "古", "外", "国", "人", "川", "近", "歩", "小", "店", "茶", "買", "母", "三", "百", "上", "町", "全", "来", "年", "行"],
    furigana: {"夏":"なつ","休":"やす","家":"か","族":"ぞく","東":"とう","新":"しん","二":"に","時":"じ","半":"はん","駅":"えき","大":"おお","山":"やま","見":"み","一":"いち","日":"にち","有":"ゆう","名":"めい","古":"ふる","外":"がい","国":"こく","人":"じん","川":"かわ","近":"ちか","歩":"ある","小":"ちい","店":"みせ","茶":"ちゃ","買":"か","母":"はは","三":"さん","百":"びゃく","上":"うえ","町":"まち","全":"ぜん","来":"らい","年":"ねん","行":"い"}
  },
];
