...
export const kanjiData: Kanji[] = [
  // Angka
  { id: 1, character: "一", onyomi: "Ichi", kunyomi: "Hitotsu", meaning: "Satu", category: "Angka", examples: [{ word: "一人", reading: "hitori", meaning: "Satu orang" }, { word: "一分", reading: "ippun", meaning: "Satu menit" }] },
  { id: 2, character: "二", onyomi: "Ni", kunyomi: "Futatsu", meaning: "Dua", category: "Angka", examples: [{ word: "二日", reading: "futsuka", meaning: "Tanggal dua" }, { word: "二人", reading: "futari", meaning: "Dua orang" }] },
  { id: 3, character: "三", onyomi: "San", kunyomi: "Mittsu", meaning: "Tiga", category: "Angka", examples: [{ word: "三日", reading: "mikka", meaning: "Tanggal tiga" }, { word: "三月", reading: "sangatsu", meaning: "Maret" }] },
  { id: 4, character: "四", onyomi: "Shi / Yon", kunyomi: "Yottsu", meaning: "Empat", category: "Angka", examples: [{ word: "四日", reading: "yokka", meaning: "Tanggal empat" }, { word: "四月", reading: "shigatsu", meaning: "April" }] },
  { id: 5, character: "五", onyomi: "Go", kunyomi: "Itsutsu", meaning: "Lima", category: "Angka", examples: [{ word: "五日", reading: "itsuka", meaning: "Tanggal lima" }, { word: "五月", reading: "gogatsu", meaning: "Mei" }] },
  { id: 6, character: "六", onyomi: "Roku", kunyomi: "Muttsu", meaning: "Enam", category: "Angka", examples: [{ word: "六日", reading: "muika", meaning: "Tanggal enam" }, { word: "六月", reading: "rokugatsu", meaning: "Juni" }] },
  { id: 7, character: "七", onyomi: "Shichi / Nana", kunyomi: "Nanatsu", meaning: "Tujuh", category: "Angka", examples: [{ word: "七日", reading: "nanoka", meaning: "Tanggal tujuh" }, { word: "七月", reading: "shichigatsu", meaning: "Juli" }] },
  { id: 8, character: "八", onyomi: "Hachi", kunyomi: "Yattsu", meaning: "Delapan", category: "Angka", examples: [{ word: "八日", reading: "youka", meaning: "Tanggal delapan" }, { word: "八月", reading: "hachigatsu", meaning: "Agustus" }] },
  { id: 9, character: "九", onyomi: "Kyuu / Ku", kunyomi: "Kokonotsu", meaning: "Sembilan", category: "Angka", examples: [{ word: "九日", reading: "kokonoka", meaning: "Tanggal sembilan" }, { word: "九月", reading: "kugatsu", meaning: "September" }] },
  { id: 10, character: "十", onyomi: "Juu", kunyomi: "Too", meaning: "Sepuluh", category: "Angka", examples: [{ word: "十日", reading: "tooka", meaning: "Tanggal sepuluh" }, { word: "十月", reading: "juugatsu", meaning: "Oktober" }] },
  ...
  // Waktu & Tanggal
  { id: 14, character: "円", onyomi: "En", kunyomi: "-", meaning: "Yen / Lingkaran", category: "Waktu & Tanggal", examples: [{ word: "百円", reading: "hyakuen", meaning: "Seratus yen" }, { word: "円い", reading: "marui", meaning: "Bulat" }] },
  { id: 15, character: "日", onyomi: "Nichi", kunyomi: "Hi", meaning: "Hari / Matahari", category: "Waktu & Tanggal", examples: [{ word: "今日", reading: "kyou", meaning: "Hari ini" }, { word: "日曜日", reading: "nichiyoubi", meaning: "Hari Minggu" }] },
  { id: 16, character: "月", onyomi: "Getsu", kunyomi: "Tsuki", meaning: "Bulan", category: "Waktu & Tanggal", examples: [{ word: "一月", reading: "ichigatsu", meaning: "Januari" }, { word: "月曜日", reading: "getsuyoubi", meaning: "Hari Senin" }] },
  { id: 17, character: "火", onyomi: "Ka", kunyomi: "Hi", meaning: "Api (Selasa)", category: "Waktu & Tanggal", examples: [{ word: "火曜日", reading: "kayoubi", meaning: "Hari Selasa" }, { word: "火山", reading: "kazan", meaning: "Gunung Berapi" }] },
  { id: 18, character: "水", onyomi: "Sui", kunyomi: "Mizu", meaning: "Air (Rabu)", category: "Waktu & Tanggal", examples: [{ word: "水曜日", reading: "suiyoubi", meaning: "Hari Rabu" }, { word: "水泳", reading: "suiei", meaning: "Berenang" }] },
  { id: 19, character: "木", onyomi: "Moku", kunyomi: "Ki", meaning: "Pohon (Kamis)", category: "Waktu & Tanggal", examples: [{ word: "木曜日", reading: "mokuyoubi", meaning: "Hari Kamis" }, { word: "大木", reading: "taiboku", meaning: "Pohon Besar" }] },
  { id: 20, character: "金", onyomi: "Kin", kunyomi: "Kane", meaning: "Emas / Uang (Jumat)", category: "Waktu & Tanggal", examples: [{ word: "金曜日", reading: "kinyoubi", meaning: "Hari Jumat" }, { word: "お金", reading: "okane", meaning: "Uang" }] },
  { id: 21, character: "土", onyomi: "Do", kunyomi: "Tsuchi", meaning: "Tanah (Sabtu)", category: "Waktu & Tanggal", examples: [{ word: "土曜日", reading: "doyoubi", meaning: "Hari Sabtu" }, { word: "土地", reading: "tochi", meaning: "Tanah" }] },
  { id: 22, character: "年", onyomi: "Nen", kunyomi: "Toshi", meaning: "Tahun", category: "Waktu & Tanggal", examples: [{ word: "今年", reading: "kotoshi", meaning: "Tahun ini" }, { word: "来年", reading: "rainen", meaning: "Tahun depan" }] },
  { id: 23, character: "今", onyomi: "Kon", kunyomi: "Ima", meaning: "Sekarang", category: "Waktu & Tanggal", examples: [{ word: "今月", reading: "kongetsu", meaning: "Bulan ini" }, { word: "今週", reading: "konshuu", meaning: "Minggu ini" }] },
  { id: 24, character: "時", onyomi: "Ji", kunyomi: "Toki", meaning: "Jam / Waktu", category: "Waktu & Tanggal", examples: [{ word: "一時", reading: "ichiji", meaning: "Jam satu" }, { word: "時間", reading: "jikan", meaning: "Waktu" }] },
  { id: 25, character: "分", onyomi: "Fun / Pun", kunyomi: "Wakaru", meaning: "Menit / Mengerti", category: "Waktu & Tanggal", examples: [{ word: "十分", reading: "juuppun", meaning: "Sepuluh menit" }, { word: "自分", reading: "jibun", meaning: "Diri sendiri" }] },
  { id: 26, character: "半", onyomi: "Han", kunyomi: "-", meaning: "Setengah", category: "Waktu & Tanggal", examples: [{ word: "三時半", reading: "sanjihan", meaning: "Jam setengah empat" }, { word: "半分", reading: "hanbun", meaning: "Setengah" }] },
  { id: 27, character: "午", onyomi: "Go", kunyomi: "-", meaning: "Siang (AM/PM)", category: "Waktu & Tanggal", examples: [{ word: "午前", reading: "gozen", meaning: "Pagi (AM)" }, { word: "午後", reading: "gogo", meaning: "Siang (PM)" }] },
